...
class TestServerAuth < Test::Unit::TestCase
  ...
  def test_uwchat_items
    ...
    assert_not_nil(Uwchat::AuthServer::PORT)
    assert_not_nil(Uwchat::AuthServer::HOST)
    assert_not_nil(Uwchat::AuthServer::MAXCONS)
